...
public:
    ...
    //either an integer as value of the node or an empty node flag
    // The empty flag can be any string. 
    //The construction will follow the rule of a complete binary tree.
    ...
    // todo: implement this
    // EFFECTS: Return the terminal node if we can 
    // go through the tree starting from the root node and along the {path}.
